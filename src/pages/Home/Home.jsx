...
const Home = () => {
  return (
    <div className="flex flex-col min-h-screen w-full overflow-x-hidden">
      ...
      <section id="home" className="w-full px-4 md:px-6 lg:px-8">
        <Hero />
      </section>
      
      {/* Buildings section with id="buildings" */}
      <section id="buildings" className="w-full px-4 md:px-6 lg:px-8 py-8 md:py-12">
        <Buildings />
      </section>
      
      {/* Rental Spaces section with id="rental-spaces" */}
      <section id="rental-spaces" className="w-full px-4 md:px-6 lg:px-8 py-8 md:py-12">
        <VacantRooms />
      </section>
      
      {/* Contact section with id="contact" */}
      <section id="contact" className="w-full px-4 md:px-6 lg:px-8 py-8 md:py-12">
        <Contact />
      </section>
